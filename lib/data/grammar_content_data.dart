  ...
  static List<GrammarCategory> getCategories() {
    return [
      const GrammarCategory(
        ...
        iconPath: 'assets/icons/light_mode/cat1_icon.png',
        color: Colors.blue,
        order: 1,
        lessonIds: [
      ...
      const GrammarCategory(
        ...
        iconPath: 'assets/icons/light_mode/cat2_icon.png',
        color: Colors.green,
        order: 2,
      ...
      const GrammarCategory(
        ...
        iconPath: 'assets/icons/light_mode/cat3_icon.png',
        color: Colors.orange,
        order: 3,
      ...
      const GrammarCategory(
        ...
        icon: Icons.star,
        iconPath: 'assets/icons/light_mode/cat4_icon.png',
        color: Colors.purple,
        order: 4,
      ...
      const GrammarCategory(
        ...
        iconPath: 'assets/icons/light_mode/cat5_icon.png',
        color: Colors.teal,
        order: 5,
