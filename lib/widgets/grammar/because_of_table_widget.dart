...
class BecauseOfTableWidget extends StatelessWidget {
  const BecauseOfTableWidget({super.key});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildDataRow(
            'Bởi vì + danh từ',
            'Because of + N/V-ing, S + V\nVí dụ: Because of the rain, we stayed home.\n(Bởi vì mưa, chúng tôi ở nhà)',
          ),
          Divider(height: 1, color: Colors.grey.shade300),
          _buildDataRow(
            'Bởi vì + mệnh đề',
            'Because + S + V, S + V\nVí dụ: Because it rained, we stayed home.\n(Bởi vì trời mưa, chúng tôi ở nhà)',
          ),
        ],
      ),
    );
