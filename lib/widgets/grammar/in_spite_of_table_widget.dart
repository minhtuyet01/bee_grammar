...
class InSpiteOfTableWidget extends StatelessWidget {
  const InSpiteOfTableWidget({super.key});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildDataRow(
            'Mặc dù + danh từ',
            'In spite of + N/V-ing, S + V\nVí dụ: In spite of the rain, we went out.\n(Mặc dù mưa, chúng tôi vẫn ra ngoài)',
          ),
          Divider(height: 1, color: Colors.grey.shade300),
          _buildDataRow(
            'Mặc dù + cụm từ',
            'In spite of + the fact that + S + V\nVí dụ: In spite of the fact that it rained, we went out.\n(Mặc dù thực tế là trời mưa, chúng tôi vẫn ra ngoài)',
          ),
        ],
      ),
    );
