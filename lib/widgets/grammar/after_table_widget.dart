...
class AfterTableWidget extends StatelessWidget {
  const AfterTableWidget({super.key});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildDataRow(
            'Sau khi + mệnh đề',
            'After + S + V, S + V\nVí dụ: After I finished homework, I watched TV.\n(Sau khi tôi làm xong bài tập, tôi xem TV)',
          ),
          Divider(height: 1, color: Colors.grey.shade300),
          _buildDataRow(
            'Sau khi + V-ing',
            'After + V-ing, S + V\nVí dụ: After finishing homework, I watched TV.\n(Sau khi làm xong bài tập, tôi xem TV)',
          ),
        ],
      ),
    );
