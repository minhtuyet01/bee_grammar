...
class ImperativeTableWidget extends StatelessWidget {
  const ImperativeTableWidget({super.key});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildDataRow('Khẳng định', 'V + O'),
          _buildExampleRow('Ví dụ: Open the door.'),
          
          Divider(height: 1, color: Colors.grey.shade300),
          
          _buildDataRow('Phủ định', 'Don\'t + V'),
          _buildExampleRow('Ví dụ: Don\'t be late.'),
          
          Divider(height: 1, color: Colors.grey.shade300),
          
          _buildDataRow('Lịch sự', 'Please + V'),
          _buildExampleRow('Ví dụ: Please sit down.'),
          
          Divider(height: 1, color: Colors.grey.shade300),
          
          _buildDataRow('Đề nghị cùng làm', 'Let\'s + V'),
          _buildExampleRow('Ví dụ: Let\'s go!'),
        ],
      ),
    );
  }
