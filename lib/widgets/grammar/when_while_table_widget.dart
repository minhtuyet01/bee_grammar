...
class WhenWhileTableWidget extends StatelessWidget {
  const WhenWhileTableWidget({super.key});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildDataRow(
            'Khi (hành động ngắn)',
            'When + S + V, S + V\nVí dụ: When I arrived, he left.\n(Khi tôi đến, anh ấy rời đi)',
          ),
          Divider(height: 1, color: Colors.grey.shade300),
          _buildDataRow(
            'Trong khi (hành động dài)',
            'While + S + V (continuous), S + V\nVí dụ: While I was studying, he called.\n(Trong khi tôi đang học, anh ấy gọi)',
          ),
        ],
      ),
    );
