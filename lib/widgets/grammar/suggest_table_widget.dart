...
class SuggestTableWidget extends StatelessWidget {
  const SuggestTableWidget({super.key});
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _buildDataRow(
            'Gợi ý làm gì',
            'Suggest + V-ing\nVí dụ: I suggest going to the park.\n(Tôi gợi ý đi công viên)',
          ),
          Divider(height: 1, color: Colors.grey.shade300),
          _buildDataRow(
            'Gợi ý ai làm gì',
            'Suggest + that + S + (should) + V\nVí dụ: I suggest that you study harder.\n(Tôi gợi ý bạn nên học chăm hơn)',
          ),
        ],
      ),
    );
