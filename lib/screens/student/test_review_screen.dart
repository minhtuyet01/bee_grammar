    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final isMC = question.type == QuestionType.multipleChoice;
          ...
          if (isMC) {
            ...
            final userAnswer = userTextAnswers[index]?.trim().toLowerCase() ?? '';
            final correctAnswer = question.correctAnswerText?.trim().toLowerCase() ?? '';
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            userTextAnswers[index]?.isNotEmpty == true 
                                ? userTextAnswers[index]! 
                                : '(Không trả lời)',
                            style: TextStyle(
